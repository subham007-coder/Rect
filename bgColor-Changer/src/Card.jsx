...
function Card({brandName, mi, xomi}) {
  return (
    <div>
        ...
        <div>
          <div class="p-4">
            <h1 class="inline-flex items-center text-lg font-semibold">
              About {brandName} {""}
              <a target="_blank" href="https://in.event.mi.com/in/smart-bundles?gad_source=1&gclid=CjwKCAiA0PuuBhBsEiwAS7fsNYiRbedORXksuphudlPMpRso4R32Hk-dXpdhKW0d2EdcFSi7_AMYdxoCxPMQAvD_BwE">
              <svg
